#!/usr/bin/env python
"""CLI for the EquiPharm Hungarian cosine v2 matching screening pipeline."""
...
try:
    from .screening import run_equipharm_hungarian_cosine_v2_screening
except ImportError:
    from screening import run_equipharm_hungarian_cosine_v2_screening


def parse_args():
    parser = argparse.ArgumentParser(description="Run EquiPharm Hungarian cosine v2 matching for any DUD-E target.")
...
def main() -> None:
    ...
    metrics = run_equipharm_hungarian_cosine_v2_screening(**config)
