"""EquiPharm Hungarian cosine v2 feature-matching screening wrapper."""
...
def run_equipharm_hungarian_cosine_v2_screening(**kwargs):
    """Run pharmacophore-feature Equiformer screening with cosine-geometry scoring."""
    ...
    kwargs.setdefault("pipeline_name", "EquiPharm_Hungarian_Cosine_v2")
    kwargs.setdefault("matching_method", "hungarian")
    kwargs.setdefault("matching_score_mode", "cosine_geometry")
