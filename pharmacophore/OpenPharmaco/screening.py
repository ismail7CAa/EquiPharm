"""OpenPharmaco command-template baseline wrapper."""
...
PIPELINE_NAME = "OpenPharmaco"


def run_openpharmaco_screening(**kwargs):
    kwargs.setdefault("pipeline_name", PIPELINE_NAME)
    return run_command_baseline_screening(**kwargs)


def run_openpharmaco_dataset_screening(**kwargs):
    kwargs.setdefault("pipeline_name", PIPELINE_NAME)
