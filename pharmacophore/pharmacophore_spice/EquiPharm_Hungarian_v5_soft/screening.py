"""SPICE-backed EquiPharm_Hungarian_v5_soft screening wrapper."""

from ..common import run_matching


def run_equipharm_hungarian_v5_soft_spice_screening(**kwargs):
    ...
    return run_matching("EquiPharm_Hungarian_v5_soft", "hungarian_cosine_quality", "hybrid_local_geometry", **kwargs)
