#!/usr/bin/env python
"""CLI for plain Equiformer screening with torsion optimization."""
...
try:
    from .screening import run_equiformer_optimization_screening
except ImportError:
    from screening import run_equiformer_optimization_screening


def parse_args():
    parser = argparse.ArgumentParser(description="Run Equiformer + optimization screening for any DUD-E target.")
...
def main() -> None:
    ...
    metrics = run_equiformer_optimization_screening(**config)
