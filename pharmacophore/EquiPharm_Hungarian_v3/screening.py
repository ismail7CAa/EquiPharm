"""EquiPharm Hungarian v3 hybrid feature-matching screening wrapper."""
...
def run_equipharm_hungarian_v3_screening(**kwargs):
    ...
    kwargs.setdefault("pipeline_name", "EquiPharm_Hungarian_v3")
