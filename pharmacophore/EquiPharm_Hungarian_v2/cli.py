#!/usr/bin/env python
"""CLI for the EquiPharm Hungarian v2 balanced matching screening pipeline."""
...
try:
    from .screening import run_equipharm_hungarian_v2_screening
except ImportError:
    from screening import run_equipharm_hungarian_v2_screening


def parse_args():
    parser = argparse.ArgumentParser(description="Run EquiPharm Hungarian v2 balanced matching for any DUD-E target.")
...
def main() -> None:
    ...
    metrics = run_equipharm_hungarian_v2_screening(**config)
