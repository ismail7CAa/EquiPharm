"""EquiPharm Hungarian v5 hard-coverage wrapper."""
...
def run_equipharm_hungarian_v5_hard_screening(**kwargs):
    """Run V5 while rejecting candidates that cannot cover every query feature."""
    ...
    kwargs.setdefault("pipeline_name", "EquiPharm_Hungarian_v5_hard")
