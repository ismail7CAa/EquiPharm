"""EquiPharm Hungarian cosine feature-matching screening wrapper."""
...
def run_equipharm_hungarian_cosine_screening(**kwargs):
    """Run pharmacophore-feature Equiformer screening with matched cosine scoring."""
    ...
    kwargs.setdefault("pipeline_name", "EquiPharm_Hungarian_Cosine")
    kwargs.setdefault("matching_method", "hungarian")
    kwargs.setdefault("matching_score_mode", "cosine")
