#!/usr/bin/env python
"""CLI for the EquiPharm Hungarian 3D matching screening pipeline."""
...
try:
    from .screening import run_equipharm_hungarian_3d_screening
except ImportError:
    from screening import run_equipharm_hungarian_3d_screening


def parse_args():
    parser = argparse.ArgumentParser(description="Run EquiPharm Hungarian 3D matching for any target.")
...
def main() -> None:
    ...
    metrics = run_equipharm_hungarian_3d_screening(**config)
