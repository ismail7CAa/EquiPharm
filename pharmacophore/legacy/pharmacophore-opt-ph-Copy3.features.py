...
# Import data 
mol2_path = "/project/IZZY/molecular-representation/dataset/DUD-E/egfr/crystal_ligand.mol2"
...
data = rdkit_mol_to_pyg_equiformer(
    ...
    y=torch.zeros((1, 19), dtype=torch.float32),  
    smiles=smiles,
    name="DUD-E_egfr_crystal_ligand",
    idx=0
)
# print(data)
...
def main():
    ...
    # Actives and Decoys
    folder_active = "/project/IZZY/molecular-representation/dataset/DUD-E/egfr/actives_sdf"
    folder_decoy  = "/project/IZZY/molecular-representation/dataset/DUD-E/egfr/decoys_sdf"
