...
def main():
    ...
    lr_decay_factor = 0.5
    weight_decay = 1e-4
    save_dir = 'checkpoints_Equiformer_exp4'
    log_dir = 'logs_Equiformer_exp4'
    ...
    ckpt = "/project/IZZY/molecular-representation/benchmarking/Methods/checkpoints_Equiformer_exp4/best_model.pt"
